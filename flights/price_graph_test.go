...
func TestGetPriceGraph(t *testing.T) {
	expected_prices := []float64{
		922, 562, 648, 654, 660, 714, 891, 594, 594, 539, 648, 715, 654, 654, 594, 594, 594, 680,
		743, 654, 699, 654, 594, 594, 654, 654, 654, 806, 755, 617, 747, 714, 680, 617, 654, 594,
		539, 539, 508, 628, 508, 508, 763, 625, 508, 659, 739, 508, 508, 508, 508, 508, 562, 508,
		508, 508, 508, 739, 508}
